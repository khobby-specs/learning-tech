...
In such cases, an attacker can easily perform an MITM technique that downgrades a secure HTTPS connection to an unencrypted HTTP connection. This is termed as SSL stripping.
